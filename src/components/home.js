...
export default function BannerSlider() {
  const [index, setIndex] = useState(null); // Bắt đầu là null để tránh hydration mismatch
  const slides = ["/image/banner.jpg", "/image/banner55.jpg"];

  useEffect(() => {
    setIndex(0); // Chỉ cập nhật sau khi component mounted
  ...
  // Tránh render khi index chưa được set
